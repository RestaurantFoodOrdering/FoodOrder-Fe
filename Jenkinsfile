 ...
 stage('Install Dependencies') {
    ...
    stage('Docker Build and Push') {
      steps {
          ...
          sh 'docker build -t msdevcoder123/food-delivery-app-fe:${VERSION} .'
          sh 'docker push msdevcoder123/food-delivery-app-fe:${VERSION}'
      }
    }
     ...
     stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: msdevcoder123\\/food-delivery-app-fe:${VERSION}/" aws/angular-manifest.yml
        '''
